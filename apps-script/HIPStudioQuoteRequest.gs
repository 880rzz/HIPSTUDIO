...
function customerLabels_(lang) {
  const labels = {
    hu:{
      name:'Név',company:'Cég / szervezet',email:'E-mail',phone:'Telefon',preferred_contact:'Preferált kapcsolattartás',pillars:'Terület',services:'Szolgáltatás',goals:'Cél',project_summary:'Projekt / kiinduló helyzet',desired_outcome:'Elvárt eredmény',must_have:'Kötelező elem',deadline:'Határidő',preferred_date_1:'Első választott időpont',preferred_date_2:'Második választott időpont',preferred_date_3:'Harmadik választott időpont',date_flexibility:'Időpont rugalmassága',location_type:'Helyszíntípus',location_details:'Helyszín részletei',reference_url:'Referencia / brief',
      business_company_size:'Cégméret',business_entities:'Érintett cégek / jogi entitások',business_payroll_headcount:'Bérszámfejtési létszám',business_monthly_invoices:'Havi számlamennyiség',business_countries:'Érintett országok',business_engagement:'Együttműködés típusa',business_current_systems:'Jelenlegi rendszerek',business_process_scope:'Érintett folyamatok',business_reporting_need:'Riporting igény',
      creative_people_count:'Résztvevők / szereplők száma',creative_final_assets:'Kért végleges anyagok',creative_locations_count:'Helyszínek száma',creative_languages:'Tartalom nyelvei',creative_addons:'Kiegészítő igények',creative_channels:'Felhasználási csatornák',creative_usage_rights:'Felhasználási jogok / terület',creative_brand_requirements:'Márka- és arculati követelmények',
      photo_outfits_setups:'Ruhák / beállítások száma',photo_retouched_images:'Retusált képek száma',photo_event_guests:'Rendezvény vendégszáma',photo_parallel_tracks:'Párhuzamos programok / termek',photo_property_spaces:'Fotózandó terek száma',photo_area_sqm:'Terület (m²)',photo_print_quantity:'Helyszíni nyomatok mennyisége',photo_key_people_moments:'Kiemelt személyek / pillanatok',photo_aerial_requirements:'Légi fotózási igény',
      video_final_length:'Végleges videó hossza',video_shoot_days:'Forgatási napok száma',video_speakers:'Szereplők / megszólalók száma',video_script_status:'Forgatókönyv állapota',stream_platform:'Streaming platform',stream_viewers:'Várható nézőszám',video_audio_music:'Hang / zene igény',video_deliverables:'Kért videós átadások',
      podcast_speakers:'Podcast résztvevők száma',podcast_episodes:'Epizódok száma',podcast_episode_length:'Epizódok tervezett hossza',podcast_distribution:'Terjesztési platformok',repurposing_outputs:'Újrafelhasználandó tartalmak',
      experience_participants:'Résztvevők száma',experience_duration:'Program időtartama',experience_languages:'Program nyelvei',experience_environment:'Helyszín / környezet',experience_travel:'Utazási igény',experience_team_profile:'Csapat profilja',experience_objective:'Program célja',experience_constraints:'Korlátok / speciális szempontok',experience_branding:'Márkázási igény',experience_logistics:'Logisztikai igények'
    },
    en:{
      name:'Name',company:'Company / organisation',email:'Email',phone:'Phone',preferred_contact:'Preferred contact method',pillars:'Area',services:'Service',goals:'Goal',project_summary:'Project / starting point',desired_outcome:'Desired outcome',must_have:'Must-have',deadline:'Deadline',preferred_date_1:'First preferred date',preferred_date_2:'Second preferred date',preferred_date_3:'Third preferred date',date_flexibility:'Date flexibility',location_type:'Location type',location_details:'Location details',reference_url:'Reference / brief',
      business_company_size:'Company size',business_entities:'Companies / legal entities involved',business_payroll_headcount:'Payroll headcount',business_monthly_invoices:'Monthly invoice volume',business_countries:'Countries involved',business_engagement:'Engagement type',business_current_systems:'Current systems',business_process_scope:'Processes in scope',business_reporting_need:'Reporting requirements',
      creative_people_count:'Number of participants / talent',creative_final_assets:'Final assets required',creative_locations_count:'Number of locations',creative_languages:'Content languages',creative_addons:'Additional requirements',creative_channels:'Usage channels',creative_usage_rights:'Usage rights / territory',creative_brand_requirements:'Brand and visual requirements',
      photo_outfits_setups:'Number of outfits / setups',photo_retouched_images:'Number of retouched images',photo_event_guests:'Event guest count',photo_parallel_tracks:'Parallel sessions / rooms',photo_property_spaces:'Number of spaces to photograph',photo_area_sqm:'Area (m²)',photo_print_quantity:'On-site print quantity',photo_key_people_moments:'Key people / moments',photo_aerial_requirements:'Aerial photography requirements',
      video_final_length:'Final video length',video_shoot_days:'Number of shoot days',video_speakers:'Number of speakers / talent',video_script_status:'Script status',stream_platform:'Streaming platform',stream_viewers:'Expected viewers',video_audio_music:'Audio / music requirements',video_deliverables:'Video deliverables required',
      podcast_speakers:'Number of podcast speakers',podcast_episodes:'Number of episodes',podcast_episode_length:'Planned episode length',podcast_distribution:'Distribution platforms',repurposing_outputs:'Repurposed content required',
      experience_participants:'Number of participants',experience_duration:'Programme duration',experience_languages:'Programme languages',experience_environment:'Venue / environment',experience_travel:'Travel requirements',experience_team_profile:'Team profile',experience_objective:'Programme objective',experience_constraints:'Constraints / special considerations',experience_branding:'Branding requirements',experience_logistics:'Logistics requirements'
    },
    de:{
      name:'Name',company:'Unternehmen / Organisation',email:'E-Mail',phone:'Telefon',preferred_contact:'Bevorzugter Kontaktweg',pillars:'Bereich',services:'Leistung',goals:'Ziel',project_summary:'Projekt / Ausgangslage',desired_outcome:'Gewünschtes Ergebnis',must_have:'Pflichtanforderung',deadline:'Frist',preferred_date_1:'Erster Wunschtermin',preferred_date_2:'Zweiter Wunschtermin',preferred_date_3:'Dritter Wunschtermin',date_flexibility:'Terminflexibilität',location_type:'Ortstyp',location_details:'Ortsangaben',reference_url:'Referenz / Briefing',
      business_company_size:'Unternehmensgröße',business_entities:'Beteiligte Unternehmen / Rechtsträger',business_payroll_headcount:'Anzahl der Lohnabrechnungen',business_monthly_invoices:'Monatliches Rechnungsvolumen',business_countries:'Beteiligte Länder',business_engagement:'Art der Zusammenarbeit',business_current_systems:'Aktuelle Systeme',business_process_scope:'Betroffene Prozesse',business_reporting_need:'Reporting-Anforderungen',
      creative_people_count:'Anzahl Teilnehmende / Mitwirkende',creative_final_assets:'Benötigte finale Inhalte',creative_locations_count:'Anzahl der Locations',creative_languages:'Sprachen der Inhalte',creative_addons:'Zusätzliche Anforderungen',creative_channels:'Nutzungskanäle',creative_usage_rights:'Nutzungsrechte / Gebiet',creative_brand_requirements:'Marken- und Gestaltungsanforderungen',
      photo_outfits_setups:'Anzahl Outfits / Setups',photo_retouched_images:'Anzahl retuschierter Bilder',photo_event_guests:'Anzahl Veranstaltungsgäste',photo_parallel_tracks:'Parallele Sessions / Räume',photo_property_spaces:'Anzahl zu fotografierender Räume',photo_area_sqm:'Fläche (m²)',photo_print_quantity:'Anzahl Vor-Ort-Ausdrucke',photo_key_people_moments:'Wichtige Personen / Momente',photo_aerial_requirements:'Anforderungen an Luftaufnahmen',
      video_final_length:'Länge des finalen Videos',video_shoot_days:'Anzahl Drehtage',video_speakers:'Anzahl Sprecher / Mitwirkende',video_script_status:'Status des Drehbuchs',stream_platform:'Streaming-Plattform',stream_viewers:'Erwartete Zuschauerzahl',video_audio_music:'Audio- / Musikanforderungen',video_deliverables:'Benötigte Videoformate',
      podcast_speakers:'Anzahl Podcast-Sprecher',podcast_episodes:'Anzahl Episoden',podcast_episode_length:'Geplante Episodenlänge',podcast_distribution:'Verbreitungsplattformen',repurposing_outputs:'Benötigte weiterverwendete Inhalte',
      experience_participants:'Anzahl Teilnehmende',experience_duration:'Programmdauer',experience_languages:'Programmsprachen',experience_environment:'Veranstaltungsort / Umgebung',experience_travel:'Reiseanforderungen',experience_team_profile:'Teamprofil',experience_objective:'Programmziel',experience_constraints:'Einschränkungen / besondere Aspekte',experience_branding:'Branding-Anforderungen',experience_logistics:'Logistikanforderungen'
    }
  }[lang] || null;
  if (!labels) throw new Error('customer_labels_language');
  CUSTOMER_FIELDS.forEach(function(k){ if (!labels[k]) throw new Error('customer_label_missing:' + lang + ':' + k); });
  return labels;
}
