...
for l in LANGS:
 ...
 home+=f'<section class="heritage"><p class="heritage-year">2006</p><div><p class="eyebrow">{e(ui("visualTrust",l))}</p><h2>{e(ui("homeEditorial",l))}</h2><p>{e(ui("homeBody",l))}</p><a href="{href("partners",l)}">{e(ui("partners",l))} ↗</a></div></section><section class="section"><div class="section-heading"><h2>{e(ui("services",l))}</h2><a href="{href("services",l)}">{e(ui("all",l))} ↗</a></div>{cards(["business","advertising","event","video","podcast","property"],l)}</section>'
