...
assert D['version']=='legal-controller-v2'
assert D['status']=='approved_identity'
...
assert D['publicationState']=='controller_identity_aligned'
print('Legal controller governance OK: Hipstudió Kft. aligned with public notice; form-specific privacy details remain')
