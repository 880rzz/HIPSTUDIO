...
assert P['version']=='hipstudio-privacy-v6'
...
print('HIPStudio privacy governance OK: controller, complaint right, GitHub Pages master hosting and Flúgos Vercel boundary explicit')
