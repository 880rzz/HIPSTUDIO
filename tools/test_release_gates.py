...
assert D['version']=='production-release-gates-v3'
...
assert g['privacy-legal']['state']=='ready_with_form_details_pending'
...
print('Production release gates OK:', len(g), 'gates; controller identity aligned, remaining blockers explicit')
